...
from monitor.routines import health_check, daily_report, drawdown_check, lock_audit, auto_demote, four_loss_audit  # noqa: E402
...
def main() -> None:
    ...
    threading.Thread(target=_runner, args=("four_loss_audit", four_loss_audit.run, 300),
                     daemon=True, name="four_loss_audit_loop").start()
